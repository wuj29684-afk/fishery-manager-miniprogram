...
- 版本状态：线上正式版为 `0.2.9`；`0.2.8` 已提交审核并因首屏登录导向被驳回；`0.2.9` 首屏免登录修复版已于 2026-07-20 约 10:44 覆盖上传体验版、20:10:59 重新提交审核、20:33 前确认审核通过，并由用户于当日确认正式发布
...
1. 观察 `0.2.9` 正式版首屏免登录体验、体验示例与可选账号同步的线上反馈。
2. 后续新版本上传、提审和正式发布仍需用户当次单独确认。
3. 依赖安全加固继续作为独立任务处理。
