...
- 版本状态：线上正式版为 `0.2.6`；`0.2.8` 已提交审核并因首屏登录导向被驳回；`0.2.9` 首屏免登录修复版已于 2026-07-20 约 10:44 覆盖上传体验版，并于 2026-07-20 20:10:59 重新提交审核，当前审核中、尚未正式发布
...
1. 等待微信完成 `0.2.9` 代码审核，并关注公众平台通知；当前预计 1-7 天。
2. 审核通过后，经用户当次单独确认再正式发布；在此之前线上版本仍为 `0.2.6`。
3. 依赖安全加固继续作为独立任务处理。
...
- 经用户当次确认，`0.2.9` 已于 2026-07-20 20:10:59 重新提交审核；公众平台显示“审核中”，预计 1-7 天内完成审核。该版本尚未正式发布，线上正式版仍为 `0.2.6`。
