...
- 版本状态：线上正式版为 `0.3.0`；`0.4.0` 已完成 Option 3 十二屏 UI、四类养殖单元图片、双仓验证、云函数部署和开发/体验版上传，尚未提交审核
...
- 截至记录时尚未提交审核、未正式发布，线上正式版仍为 `0.3.0`。
